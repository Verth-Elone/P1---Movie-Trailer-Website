...
'''
The original module was provided for the Full Stack Web Developer Nanodegree at Udacity.com.
Site of module: https://github.com/adarsh0806/ud036_StarterCode/blob/master/fresh_tomatoes.py

I have changed the module slightly to reflect my vision of the Movie Trailer Website project.
'''
...
movie_tile_content = '''
<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 movie-tile" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
