...
'''
    ...
    Creates instance of class Movies named "movies",
    creates few instances of class Movie,
...
if __name__ == "__main__":
    ...
    m1 = media.Movie("Star Wars: Episode VII - The Force Awakens",
                     ...
                     "/M/MV5BMTkwNzAwNDA4N15BMl5BanBnXkFtZTgwMTA2MDcwNzE@" +
                     "._V1_SX214_AL_.jpg",
                     ...
                     "Michael Arndt, Goerge Lucas",
                     "Harrison Ford, Mark Hamill, Carrie Fisher, ...")
    m2 = media.Movie("Warcraft",
                     "http://ia.media-imdb.com/images" +
                     "/M/MV5BMTgxMDAzNzMyMV5BMl5BanBnXkFtZTgwNjIwMTgxNzE@" +
    ...
    m3 = media.Movie("Jurassic World",
                     "http://ia.media-imdb.com/images" +
                     "/M/MV5BMTQ5MTE0MTk3Nl5BMl5BanBnXkFtZTgwMjczMzk2NTE@" +
                     "._V1_SX214_AL_.jpg",
